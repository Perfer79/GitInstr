...
При  слиянии веток случаются конфликты конфликты. Основная причина конфликтов - изменения в одной из веток части кода присутствующего в обеих ветках. VSC сигнализирует о конфликте и подсвечивает участок кода, в котором возник конфликт, а также предлагает пути решения путем выбора из набора вариантов:
...
Этот текст в HW2branch1. Должен пропасть при переходе в master.

Этот текст в HW2branch2. Должен пропасть при переходе в master. Сделаны изменения в строке 85 сделаны изменения для конфликта.

Этот текст в HW2branch3. Должен пропасть при переходе в master. 